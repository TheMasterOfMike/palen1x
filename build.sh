...
apt-get update
apt-get install -y --no-install-recommends gcompat wget gawk debootstrap mtools xorriso ca-certificates curl libusb-1.0-0-dev gcc make gzip xz-utils unzip libc6-dev
